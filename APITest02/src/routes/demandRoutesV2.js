...
=======
demandRoutesV2.get("/", async (req, res) => {
>>>>>>> 104a237626d71825a0433a839c63b7cadc0a6a65
...
=======
      const data = await getDemandDataV2(req.query.selectedSkills);
>>>>>>> 104a237626d71825a0433a839c63b7cadc0a6a65
...
<<<<<<< HEAD
demandRoutesV2.get("/ASC", (req, res) => {
=======
...
demandRoutesV2.get("/DESC", (req, res) => {
  const accessControl = new AccessControl(
    getApplicationAccessControlDefinition()
  );
  if (accessControl.can(req.decodedToken.role).readAny("demand").granted) {
    try {
      const data = getDemandDataV2DESC(
        req.query.selectedSkills,
        req.query.columnName
      );
      res.status(200).json(data);
