export class Demand {
    constructor(demandID, codeRequisition, startDate, clientID, originatorName, skillsID, probability, grade, selectedApplicant, status, notes, proposedApplicant, creationDate, location) {
